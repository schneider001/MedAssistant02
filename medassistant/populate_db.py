...
from app_medassistant.models import Patient, Request, Symptom, Disease, Comment, RequestSymptom, MLModel
from django.contrib.auth.models import User
from django.utils.encoding import force_bytes

from app_medassistant import ML_MODEL_VERSION
...
def populate_database():
    ...
    MLModel.objects.create(hash=force_bytes('some_hash'), version=ML_MODEL_VERSION) #Вынести версию модели в конфиг
